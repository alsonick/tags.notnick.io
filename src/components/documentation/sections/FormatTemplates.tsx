          ...
          <AccordionContent className="flex flex-col gap-4">
            {format.formats.map((entry) => (
              <div key={entry.constraint}>
                <p className="mb-1.5 font-mono text-xs text-gray-500">{entry.constraint}</p>
...
export const FormatTemplates = () => {
  return (
    <div className="flex flex-col">
      ...
      <h3 className="mb-4 mt-8 text-lg font-bold tracking-tight text-gray-900">Supported Formats</h3>
      <FormatAccordion formats={supportedFormats} />

      <h3 className="mb-4 mt-8 text-lg font-bold tracking-tight text-gray-900">Additional Format Templates</h3>
